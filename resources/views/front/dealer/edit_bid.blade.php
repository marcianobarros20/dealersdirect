                ...
                {{ Form::open(array('url' => '/dealers/edit-bid/', 'files'=>true)) }}
                    <div class="form_back">
                        <div class="form-group">
                            ...
                            {{ Form::hidden('request_id',$BidQueue->requestqueue_id,'') }}
                            {{ Form::text('total_amount',$BidQueue->total_amount,['class' => 'form-control profile_control','required'=>'required']) }}
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName1">Monthly Amount</label>
                            {{ Form::text('monthly_amount',$BidQueue->monthly_amount,['class' => 'form-control profile_control','required'=>'required']) }}
                        </div>
                        @if(!empty($RequestQueue->trade_ins))
                        <div class="form-group">
                            <label for="exampleInputName1">Trade In Amount</label>
                            {{ Form::text('trade_in',$BidQueue->trade_in,['class' => 'form-control profile_control']) }}
                        </div>
                        @else
                            {{ Form::hidden('trade_in',$BidQueue->details,['class' => 'form-control profile_control']) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::textarea('details',$BidQueue->details,['class'=>'form-control profile_control','rows'=>'5','required'=>'required']) }}
                        </div>
                        <?php   $keys=0;
                        ...
                        {{ Form::submit('EDIT YOUR PREVIOUS BID',array('class' => 'btn btn-default btn-lg btn-block')) }}
                    </div> <!-- /form_back -->
                {!! Form::close() !!}
            </div>  <!-- /col-xs-8 -->
