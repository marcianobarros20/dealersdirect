                            ...
                            <div class="blog-content">
                                <div class="blog-content-wrap">
                                    ...
                                    <div class="blog-read-more">
                                        <br />
                                        <a href=""  data-id="{!!  $RequestQueue->id !!}" data-count="{!!$countnum!!}" data-colorid="{!!  $value->color_id !!}" class="button light small add_exterior_color"><span class="icon-checkmark2"></span><b>Add This Exterior Color</b></a>
                                    </div>
                                    <!-- .read more -->
